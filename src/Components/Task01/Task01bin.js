	...
	return (
		<div className={styles.wrapper_bin}>
			...
			<div className={styles.btns_bin}>
				<div className={styles.btns_add_block}>
					<button
				...
				<div className={styles.btn_box_click_buy}>
					<button
						onClick={handleBuy}
			...
			<div className={styles.box_add_magazin}>
				...
				<div className={styles.btn_box_add_magazin}>
					<button
						onClick={handleClickAddMagazin}
						disabled={addMagazinState !== 0 ? false : true}
						className={styles.btn_add_magazin}
					>
						Dodaj
					</button>
				</div>
